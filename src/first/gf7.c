/*=========================================
 * gf7.c : C-version of GradientFunction7v2.m (Jose Luis)
 *
 ...
 * g : gradients of cost function
 * ========================================== */
void gf7(double *x, double *kx, double *kf, double *Mre, double *Mim,
		 ...
		 double *f, double *g)	 
{
	...
	double re_rho_m, im_rho_m, re_gphi, im_gphi, re_gR2, im_gR2, expR2; 
	double Dqr,Dqi;
...
/* function f = GradientFunction7v2(x, kx, kf, M, frequency_offset, x_positions) */
	...
	gf7(x, kx, kf, Mre, Mim, fo, xpos, N, M, Nacq, f, g);
